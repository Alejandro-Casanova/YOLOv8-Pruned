...
parser.add_argument('-m', '--model', type=str, default="my-models/best_00_imgsz320.onnx", help="Path to ONNX model")
...
os.makedirs(f'my-models/export_results/{model_class}/{prune_rate}', exist_ok=True)
with open(f'my-models/export_results/{model_class}/{prune_rate}/{args.seed}.json', 'w') as f:
